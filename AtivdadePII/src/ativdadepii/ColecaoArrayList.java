...
public class ColecaoArrayList {
    ...
    public static void main(String[] args) {
        ...
        display(items, "\nO conteúdo da lista de exibição com instrução para aprimorada:");

        items.add("verde");      // adiciona "green" ao final da lista
        items.add("amarelo");    // adiciona "yellow" ao final da lista      
        ...
        System.out.printf("\"rerde\" é %perca a lista\n", items.contains("verde") ? "" : "não ");
